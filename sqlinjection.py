...
Original file is located at
    https://colab.research.google.com/drive/1QDTUzW_ln2KrOarNw9-Od4mnVeFopENb
"""
...
def form_details(form):
  ...
  for inputs_tag in form.find_all("input"):
    input_type = inputs_tag.attrs.get("type", "text")
    input_name = inputs_tag.attrs.get("name")
    input_value = inputs_tag.attrs.get("value", "")
    inputs.append({
        "type": input_type,
        "name": input_name,
        "value": input_value
  ...
  def vulnerable(response):
    errors = {"quoted string not properly terminted",
  ...
  def sql_injection_scan(url):
    ...
    for i in "\"'":
      ...
      if vulnerable(res):
        ...
        print("No SQL injection  attack vulnerbility detected")
        break
